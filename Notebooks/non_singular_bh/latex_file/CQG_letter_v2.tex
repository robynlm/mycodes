...
\def\mbt#1{\textcolor{red}{#1}}

\def\rmc#1{\textcolor{blue}{\tt[MB: #1]}}
\def\rmt#1{\textcolor{blue}{#1}}
...
\ead{marco.bruni@port.ac.uk robyn.munoz@port.ac.uk, jackneville99@yahoo.co.uk}
