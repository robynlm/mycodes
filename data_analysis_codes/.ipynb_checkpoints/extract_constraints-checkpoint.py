...
class MyClass:
    ...
    def getvals(self, it):
        ...
        # Get rho
        if (self.get_key('ADMBASE', 'alp', it) in f.keys()) and (self.get_key('TMUNUBASE', 'eTtt', it) in f.keys()):
            ...
            if (self.get_key('ADMBASE', 'betax', it) in f.keys()) and (self.get_key('TMUNUBASE', 'eTtt', it) in f.keys()):
