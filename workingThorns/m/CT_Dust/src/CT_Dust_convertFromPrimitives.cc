...
static void CT_Dust_convertFromPrimitives_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL DDL CCTK_ATTRIBUTE_UNUSED = rhoL*W;
    
    CCTK_REAL EEL CCTK_ATTRIBUTE_UNUSED = epsL*rhoL*W;
    
    CCTK_REAL SS1L CCTK_ATTRIBUTE_UNUSED = rhoL*h*u1*W;
    
    CCTK_REAL SS2L CCTK_ATTRIBUTE_UNUSED = rhoL*h*u2*W;
    
    CCTK_REAL SS3L CCTK_ATTRIBUTE_UNUSED = rhoL*h*u3*W;
    /* Copy local copies back to grid functions */
    DD[index] = DDL;
    EE[index] = EEL;
    SS1[index] = SS1L;
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_convertFromPrimitives
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_convertFromPrimitives);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  const char* const groups[] = {
    ...
    "HydroBase::vel",
    "HydroBase::w_lorentz"};
  AssertGroupStorage(cctkGH, "CT_Dust_convertFromPrimitives", 8, groups);
