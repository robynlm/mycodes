...
static void CT_Dust_FLRW_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL aa CCTK_ATTRIBUTE_UNUSED = 
      pflrw_a0*pow(t*pow(pflrw_t0,-1),0.666666666666666666666666666667*pow(1 
      + eosw,-1));
    ...
    rhoL = 0.119366207318921501826662822529*pow(HH,2);
    
    CCTK_REAL epsL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL pressL CCTK_ATTRIBUTE_UNUSED = rhoL*eosw;
    
    CCTK_REAL velxL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL velyL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL velzL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL w_lorentzL CCTK_ATTRIBUTE_UNUSED = 1;
    /* Copy local copies back to grid functions */
    alp[index] = alpL;
    betax[index] = betaxL;
    betay[index] = betayL;
  ...
  CCTK_ENDLOOP3(CT_Dust_FLRW);
}
extern "C" void CT_Dust_FLRW(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_FLRW
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_FLRW);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_FLRW_Body");
  }
  if (cctk_iteration % CT_Dust_FLRW_calc_every != CT_Dust_FLRW_calc_offset)
  {
    return;
  }
  ...
  const char* const groups[] = {
    ...
    "HydroBase::vel",
    "HydroBase::w_lorentz"};
  AssertGroupStorage(cctkGH, "CT_Dust_FLRW", 9, groups);
  ...
  LoopOverEverything(cctkGH, CT_Dust_FLRW_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_FLRW_Body");
  }
}
