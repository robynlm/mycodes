...
extern "C" void CT_Dust_ExpansionBoundary_SelectBCs(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_ExpansionBoundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_ExpansionBoundary_SelectBCs);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  
  if (cctk_iteration % CT_Dust_ExpansionBoundary_calc_every != CT_Dust_ExpansionBoundary_calc_offset)
    return;
...
static void CT_Dust_ExpansionBoundary_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  #pragma omp parallel
  CCTK_LOOP3(CT_Dust_ExpansionBoundary,
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL sigmattL CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmats1L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmats2L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmats3L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass11L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass12L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass13L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass22L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass23L CCTK_ATTRIBUTE_UNUSED = 0;
    
    CCTK_REAL sigmass33L CCTK_ATTRIBUTE_UNUSED = 0;
    /* Copy local copies back to grid functions */
  ...
  CCTK_ENDLOOP3(CT_Dust_ExpansionBoundary);
}
extern "C" void CT_Dust_ExpansionBoundary(CCTK_ARGUMENTS)
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_ExpansionBoundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_ExpansionBoundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering CT_Dust_ExpansionBoundary_Body");
  }
  if (cctk_iteration % CT_Dust_ExpansionBoundary_calc_every != CT_Dust_ExpansionBoundary_calc_offset)
  {
    return;
  ...
  const char* const groups[] = {
    ...
    "CT_Dust::CT_sigmatt",
    "CT_Dust::CT_Theta"};
  AssertGroupStorage(cctkGH, "CT_Dust_ExpansionBoundary", 4, groups);
  ...
  LoopOverBoundary(cctkGH, CT_Dust_ExpansionBoundary_Body);
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving CT_Dust_ExpansionBoundary_Body");
  }
}
