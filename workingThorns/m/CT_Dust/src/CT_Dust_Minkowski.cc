...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_Minkowski
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_Minkowski);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  const char* const groups[] = {
    ...
    "HydroBase::vel",
    "HydroBase::w_lorentz"};
  AssertGroupStorage(cctkGH, "CT_Dust_Minkowski", 9, groups);
