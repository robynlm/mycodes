...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_boundary_SelectBCs
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_boundary_SelectBCs);
  #else
  ...
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_D","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_D.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_E","flat");
  if (ierr < 0)
    CCTK_WARN(CCTK_WARN_ALERT, "Failed to register flat BC for CT_Dust::CT_E.");
  ierr = KrancBdy_SelectGroupForBC(cctkGH, CCTK_ALL_FACES, GetBoundaryWidth(cctkGH), -1 /* no table */, "CT_Dust::CT_S","flat");
  if (ierr < 0)
...
{
  #ifdef DECLARE_CCTK_ARGUMENTS_CT_Dust_boundary
  DECLARE_CCTK_ARGUMENTS_CHECKED(CT_Dust_boundary);
  #else
  DECLARE_CCTK_ARGUMENTS;
  #endif
  DECLARE_CCTK_PARAMETERS;
  ...
  LoopOverBoundary(cctkGH, CT_Dust_boundary_Body);
  if (verbose > 1)
  {
